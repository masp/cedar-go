	...
	for {
		...
		/*!re2c
		  		...
		  		* { err = ErrUnrecognizedToken; return }
		          ...
		          // Reserved types
		          "Bool" { tok = token.BOOL_TYPE; lit = "Bool"; return }
		          "Long" { tok = token.LONG_TYPE; lit = "Long"; return }
		          "String" { tok = token.STRING_TYPE; lit = "String"; return }
		          "Set" { tok = token.SET_TYPE; lit = "Set"; return }
