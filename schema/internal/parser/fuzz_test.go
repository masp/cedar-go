...
// Run with:
//
//	go test -fuzz=FuzzParseSchema -fuzztime=60s github.com/cedar-policy/cedar-go/schema/parser
func FuzzParseSchema(f *testing.F) {
	...
	f.Add(read("testdata/convert_test.cedarschema"))
	f.Add(read("testdata/format_test.cedarschema"))
